...
Have a look at the [`core/persist-root-home`](https://github.com/rugix/rugix/tree/main/bakery/repositories/core/recipes/persist-root-home) recipe as an example that installs the configuration stated above.
:::
