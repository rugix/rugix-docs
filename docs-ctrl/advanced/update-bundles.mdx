...
Bundle verification is mandatory by default. Either a valid [embedded signature](../signed-updates.md) or a bundle hash must be provided.
See [Signed Updates](../signed-updates.md) for details on configuring signature-based verification.
