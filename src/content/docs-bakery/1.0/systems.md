...
For supported devices and the required targets, checkout the documentation on [Supported Devices](/docs/bakery/devices/).
...
The image layout is specified in the `image.layout` section. For details, we refer to the [project configuration reference](/docs/bakery/projects#project-configuration).
