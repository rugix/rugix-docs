...
import ProjectSchema from "../../../schemas/rugix-bakery-project.schema.json";
...
:::tip
You can initialize a project from a variety of templates with `./run-bakery init`. You can also browse the [templates on GitHub](https://github.com/rugix/rugix/tree/main/bakery/templates) to get an idea of how Rugix Bakery projects for different distributions and devices may look like.
:::
...
<SchemaViewer schema={ProjectSchema} />
You will find the most recent version of this schema [on GitHub](https://github.com/rugix/rugix-bakery/blob/main/schemas/rugix-bakery-project.schema.json).
