...
Migrating from RAUC to Rugix Ctrl requires a [system configuration file](../system-updates/system-configuration) that specifies the correct RAUC-compatible boot flow, boot groups, and slots.
