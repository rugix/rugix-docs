...
- **[Yocto](./yocto)**, full-distro control via the official [`meta-rugix`](https://github.com/rugix/meta-rugix) layers. Use this if you are already invested in Yocto, need a tightly-tailored embedded distribution, or have specific BSP requirements.
