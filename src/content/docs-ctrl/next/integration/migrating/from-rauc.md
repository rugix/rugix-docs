...
Migrating from RAUC to Rugix Ctrl requires a [system configuration file](../../updates/system-updates/system-configuration) that specifies the correct RAUC-compatible boot flow, boot groups, and slots.
...
Like RAUC, Rugix Ctrl is not limited to A/B setups.
