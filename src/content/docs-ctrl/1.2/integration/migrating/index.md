...
To facilitate **safe migrations of already deployed devices** from other OTA solutions, Rugix Ctrl provides [boot flows](../../updates/system-updates/boot-flows) that are compatible with other OTA update solutions and that mimic the way those solutions interact with the bootloader to install updates.
...
It does not cover any custom integrations that you may have implemented with another OTA solution.
