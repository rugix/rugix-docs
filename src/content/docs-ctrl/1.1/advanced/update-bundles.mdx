...
Typically, for each payload, the update bundle specifies a slot (see [System Configuration: Slots and Boot Groups](./system-configuration#update-slots)) to which the payload should be installed.
...
See [Signed Updates](../signed-updates) for details on configuring signature-based verification.
