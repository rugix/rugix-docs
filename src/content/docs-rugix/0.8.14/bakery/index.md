...
Edi's reference support for over-the-air updates reuses the Mender client [which lacks certain features, like dynamic delta updates, that you may want and get with Rugix Ctrl](../ctrl/index#comparison-to-other-solutions) and its integration in Rugix Bakery.
