...
Typically, for each payload, the update bundle specifies a slot (see [System Configuration: Slots and Boot Groups](/docs/0.8.14/ctrl/advanced/system-configuration#update-slots)) to which the payload should be installed.
