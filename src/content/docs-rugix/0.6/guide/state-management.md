...
Likewise, another button could be programmed to initiate a reboot to the spare system (see [Over-the-Air Updates](/docs/0.6/guide/over-the-air-updates)), increasing the resiliency even further.
