...
- Partition 6: Contains any persistent state (see [State Management](/docs/0.7.5/guide/state-management)).
...
Note that a persistent overlay that may exist for the spare partition is deleted prior to installing the update (see [State Management](/docs/0.7.5/guide/state-management)).
