...
An _image declaration_ has the following structure:
...
For further details on layers, checkout the [user guide's section on System Customization](/docs/0.7.5/guide/system-customization).
...
When building a system image with Rugpi, you need to specify a _target_ that is appropriate for your device.
