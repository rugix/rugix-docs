...
At the same time Rugix Ctrl gained a lot more features (details below), making it [competitive with respect to established standalone solutions such as SWUpdate or RAUC](/blog/2026-02-28-ota-update-engines-compared).
...
Checkout, the [how to upgrade guide for details](/docs/0.8.14/upgrading-from-v0.7).
