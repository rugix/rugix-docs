...
In addition, it makes it much easier to share recipes with the community via Rugpi _repositories_.

**(1) Layers.**  With version 0.6, we introduce the concept of _layers_.
...
With version 0.6, we introduce _repositories_, making it much easier to share recipes and layers.
...
Got ideas or suggestions? Please open a [discussion](https://github.com/rugix/rugix/discussions) or [issue](https://github.com/rugix/rugix/issues) on Github.
