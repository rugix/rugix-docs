  ...
  return (
    <div className="delta-savings-calculator prose-reset">
        ...
        <table className="delta-savings-table">
          ...
          <thead>
            <tr>
              ...
              <th scope="col" className="delta-savings-num">
                Cost / year
              </th>
              <th scope="col" className="delta-savings-num">
                Savings / year
          ...
          <tbody>
            <tr className="delta-savings-baseline">
              <th scope="row">No delta updates</th>
      ...
      <p className="delta-savings-footnote">
        ...
        Bookworm and Bullseye snapshots. Actual savings depend on your update
        content. The default 0.09 USD/GiB matches AWS S3 egress.
      </p>
    </div>
  )
}
